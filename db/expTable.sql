...
spool E:\LocalRepository\github\leimaau-npm-cdn\db\tab_1998_bw.txt
...
spool E:\LocalRepository\github\leimaau-npm-cdn\db\tab_2007.txt
select tab_id||'$'||trad||'$'||simp||'$'||ipa_s||'$'||ipa_t||'$'||jyutping||'$'||replace(sour,'2007年謝建猷《廣西漢語方言研究》','')||'$'||expl||'$'||note from v_nbdict_2007 order by tab_id;

spool E:\LocalRepository\github\leimaau-npm-cdn\db\tab_2008.txt
...
spool E:\LocalRepository\github\leimaau-npm-cdn\db\tab_2017_bw.txt
